declare module "javascript/utils" {
    ...
    export const scaleVector: ([x0, y0]: [any, any], length: any) => number[];
...
declare module "javascript/book-utils" {
    ...
    export const indexBook: (bookText: string) => BookIndex;
    ...
    export const stringBook: (initialText?: string) => EditableBook;
...
declare module "javascript/formats/fodt-template" {
    ...
    const template: (content: any, properties: any) => string;
