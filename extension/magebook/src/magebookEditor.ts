...
export class MagebookEditorProvider implements vscode.CustomTextEditorProvider {
	...
	private getHtmlForWebview(webviewPanel: vscode.WebviewPanel) : string {
		const localFile = (fpath : string) => {
			const onDiskPath = vscode.Uri.file(
				path.join(this.context.extensionPath, 'editor', ...fpath.split('/'))
			);
