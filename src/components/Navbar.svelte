...
<nav class={($showSidemenu ? "display" : "hidden")}>
  ...
  <div>
    ...
    <div class="content">
      ...
      <hr>
      <a href={$_('navbar.export.otherslink')} target="_blank" rel="noreferrer">{$_('navbar.export.others')}</a>
      <hr>
      <a href={$_('navbar.export.settingslink')} target="_blank" rel="noreferrer">{$_('navbar.export.settings')}</a>
    </div>
  </div>
  {/if}
  ...
  <div>
    ...
    <div class="content">
      ...
      <a target="_blank" rel="noreferrer" href="https://www.librogame.net/index.php/forum/topic?id=5182&p=1#p148583">
        {$_('navbar.help.forum')} 
      </a>
      <a target="_blank" rel="noreferrer" href="https://docs.google.com/document/d/1BlAlzgdoFxTNodg501R4kDVG0I7JeBJjPuJsMSP47sg/edit?usp=sharing">
...
<style>
  ...
  .margin {
    margin: auto;/* border-right: 1px solid #eeeeee44; height: 1.2rem;*/
  }
  ...
  nav {
    ...
    display: flex;
    flex-direction: row;
    background-color: var(--vscode-breadcrumb-background,#333);
  ...
  nav :global(.nav-element), .dropbtn, .content > * {
    display: block;
  ...
  :global(.vscode) nav :global(.nav-element), :global(.vscode) .dropbtn, :global(.vscode) .content > * {
  ...
  nav div:hover :global(.nav-element), nav > :global(.nav-element):hover,  div:hover .dropbtn{
